...
public class ProjectEulerRunner
{
    public static void main(String[] args)
    {
        ...
        switch (choice)
        {
            ...
            case 10:
                System.out.println("Solve Time: 73 ms");
                System.out.println(ProjectEuler010.run() + " (Answer: 142913828922)");
                break;
    
            case 11:
                System.out.println("Solve Time: 47 ms");
                System.out.println(ProjectEuler011.run() + " (Answer: 70600674)");
                break;
            ...
            case 32:
                System.out.println("Solve Time: 368 ms");
                System.out.println(ProjectEuler032.run() + " (Answer: 45228)");
                break;
            ...
            case 125:
                System.out.println("Solve Time: 1027323 ms");
